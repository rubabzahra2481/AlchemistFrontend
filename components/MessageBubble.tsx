  ...
  return (
    <div style={{
      ...
      >
        {/* Message Bubble */}
        <div style={{
          padding: isEditing ? '16px' : (isUser ? '12px 20px' : '16px 20px'),
          borderRadius: isUser 
            ? `${borderRadius.md} ${borderRadius.md} 4px ${borderRadius.md}`
            : `${borderRadius.md} ${borderRadius.md} ${borderRadius.md} 4px`,
          background: isEditing 
            ? `linear-gradient(135deg, ${colors.architectIndigo} 0%, ${colors.scaleOrange} 100%)`
            : (isUser ? colors.architectScale : colors.white),
          color: isUser ? colors.white : colors.black,
          boxShadow: isEditing ? shadows.lg : shadows.md,
          position: 'relative',
          ...
          {isEditing ? (
            ...
            <div style={{
              ...
              <div style={{
                fontFamily: typography.body.fontFamily,
                fontSize: "16px",
                lineHeight: isUser ? '1.4' : typography.body.lineHeight,
                margin: 0,
              }}>
